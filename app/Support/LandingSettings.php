...
class LandingSettings
{
    private const DEFAULTS = [
        ...
        'hero_title' => 'Farmasi UBP Karawang',
        'hero_highlight' => 'Satu Akses Digital',
        'hero_description' => 'Portal resmi Fakultas Farmasi UBP Karawang untuk membuka layanan akademik, administrasi, program studi, laboratorium, dan bantuan akses dalam satu halaman.',
        'hero_image_url' => null,
        'hero_primary_button' => 'Kenali Layanan',
        'hero_secondary_button' => 'Lihat Aplikasi',
