...
class DatabaseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $settings = [
            ...
            ['hero', 'text', 'hero_title', 'Satu Akses untuk Seluruh Layanan Digital Farmasi UBP'],
            ['hero', 'textarea', 'hero_description', 'Portal resmi Fakultas Farmasi Universitas Buana Perjuangan Karawang untuk membuka aplikasi akademik, administrasi, formulir, program studi, dan bantuan akses.'],
